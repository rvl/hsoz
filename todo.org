...
** Hackage stuff
*** TODO specify 'license-file' in cabal
*** TODO cut down 'description' in cabal
    Hackage doesn't support formatting in the description text.
*** TODO set package "stability" attribute
*** TODO move description into README.md
*** TODO add README.md as an extra source in cabal
